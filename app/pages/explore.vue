  ...
  <div class="fixed inset-0 w-full h-full bg-cover bg-center flex font-sans" style="background-image: url('/bg-new.svg')">
    ...
    <div class="w-[20%] flex flex-col pt-12 items-center relative z-10 shrink-0">
      ...
      <div class="flex flex-col w-full relative">
        ...
        <div class="absolute left-0 w-[90%] h-12 bg-white rounded-r-full shadow-[0_0_15px_rgba(255,255,255,1)] transition-all duration-500 ease-in-out z-0 top-82"/>
        
        <div class="h-16 flex items-center pl-[25%] text-lg transition-all duration-300 relative z-10 text-[#4B6B8A] opacity-80">表情识别</div>
        <div class="h-16 flex items-center pl-[25%] text-lg transition-all duration-300 relative z-10 text-[#4B6B8A] opacity-80">选择情绪</div>
        <div class="h-16 flex items-center pl-[25%] text-lg transition-all duration-300 relative z-10 text-[#4B6B8A] opacity-80">生活状态</div>
        <div class="h-16 flex items-center pl-[25%] text-lg transition-all duration-300 relative z-10 text-[#4B6B8A] opacity-80">照片生成</div>
        <div class="h-16 flex items-center pl-[25%] text-lg transition-all duration-300 relative z-10 text-[#4B6B8A] opacity-80">口令生成</div>
        <div class="h-16 flex items-center pl-[25%] text-xl transition-all duration-300 relative z-10 text-[#2A4365] font-bold">扔出瓶子</div>
      </div>
    </div>
